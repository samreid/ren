/**
 * Forked from JOIST/Sim.js to remove the navigation bar
 *
 * @author Sam Reid
 */
define( function( require ) {
   ...
   * @constructor
   */
  function Game( name, screens, options ) {
...
//    sim.navigationBar = new NavigationBar( sim, screens, sim.simModel );
  ...
  Game.prototype.resizeToWindow = function() {
...
//    sim.navigationBar.y = height - navBarHeight;
    ...
    _.each( sim.screens, function( m ) { m.view.layout( width, height ); } );
...
//  };
  ...
  Game.prototype.addChild = function( node ) {
  ...
  Game.prototype.getRecordedInputEventLogString = function() {
  ...
  Game.prototype.getEventLogName = function() {
  ...
  Game.prototype.getEventLogLocation = function() {
  ...
  Game.prototype.submitEventLog = function() {
  ...
  // submits a recorded event log to the same-origin server (run scenery/tests/event-logs/server/server.js with Node, from the same directory)
  Game.prototype.mailEventLog = function() {
    // if we aren't recording data, don't submit any!
    if ( !this.options.recordInputEventLog ) { return; }
  ...
  Game.prototype.fuzzMouseEvents = function() {
    var sim = this;
